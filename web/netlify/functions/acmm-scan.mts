...
const CRITERIA: Criterion[] = [
  ...
  { id: "acmm:quality-dashboard", source: "acmm", level: 3, category: "observability", name: "Quality dashboard", detection: { type: "any-of", pattern: ["public/analytics.js", "web/public/analytics.js", "web/src/components/analytics/", "docs/quality.md", ".github/workflows/quality-report.yml", "docs/AI-QUALITY-ASSURANCE.md"] } },
  ...
  { id: "acmm:multi-agent-orchestration", source: "acmm", level: 6, category: "autonomy", name: "Multi-agent orchestration", detection: { type: "any-of", pattern: [".github/workflows/dispatcher.yml", ".github/workflows/orchestrate.yml", "scripts/orchestrate.mjs", "docs/multi-agent.md", ".claude/dispatcher/", "orchestrator/"] } },
  ...
  { id: "acmm:risk-assessment-config", source: "acmm", level: 6, category: "governance", name: "Risk assessment config", detection: { type: "any-of", pattern: ["risk-config.json", ".claude/risk-config.json", ".github/risk-assessment.yml"] } },
